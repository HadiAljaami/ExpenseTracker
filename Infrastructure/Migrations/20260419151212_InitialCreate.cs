    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "#FF6B6B", new DateTime(2026, 4, 19, 15, 12, 12, 155, DateTimeKind.Utc).AddTicks(1995), "🍔", "Food & Dining", null },
                    { 2, "#4ECDC4", new DateTime(2026, 4, 19, 15, 12, 12, 155, DateTimeKind.Utc).AddTicks(1998), "🚗", "Transport", null },
                    { 3, "#45B7D1", new DateTime(2026, 4, 19, 15, 12, 12, 155, DateTimeKind.Utc).AddTicks(2001), "💡", "Bills & Utilities", null },
                    { 4, "#96CEB4", new DateTime(2026, 4, 19, 15, 12, 12, 155, DateTimeKind.Utc).AddTicks(2003), "🎬", "Entertainment", null },
                    { 5, "#FFEAA7", new DateTime(2026, 4, 19, 15, 12, 12, 155, DateTimeKind.Utc).AddTicks(2006), "🏥", "Healthcare", null },
                    { 6, "#DDA0DD", new DateTime(2026, 4, 19, 15, 12, 12, 155, DateTimeKind.Utc).AddTicks(2008), "🛍️", "Shopping", null },
                    { 7, "#98D8C8", new DateTime(2026, 4, 19, 15, 12, 12, 155, DateTimeKind.Utc).AddTicks(2010), "📚", "Education", null },
                    { 8, "#B0BEC5", new DateTime(2026, 4, 19, 15, 12, 12, 155, DateTimeKind.Utc).AddTicks(2013), "📦", "Other", null }
                });
